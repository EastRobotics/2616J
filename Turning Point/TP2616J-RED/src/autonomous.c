...
// Flywheel and Intake Start
  ...
  turn_left(632, 90, 750);

  printf("turn\r\n");
motor_tare_position(10);
drive_straight(10, 320, 127, 200);
set_motors(0);
delay(1000);
doub_shot();
motor_move(MOTOR_INTAKE, 127);
 ...
 drive_straight(10, -475, -90, 200);
 set_motors(0);
 delay(100);

 drive_straight(10, 1550, 60, 200);
 set_motors(0);
 delay(500);
 ...
 // motor_move(MOTOR_INTAKE, 0);
 //
 // drive_straight(10, 450, 60, 200);
 // set_motors(0);
 // delay(500);
 //
 // turn_left(634, 100, 500);
 //
 // drive_straight(10, -4250, -200, 200);
 // set_motors(-5);
 // delay(500);

//Cap and Shot Code
 drive_straight(10, -50, -60, 200);
 set_motors(0);
 delay(500);

turn_left(360, 100, 500);
drive_straight(10, 600, 100, 200);
motor_move_relative(MOTOR_INDEXER, 1000, 127);//(MOTOR_INDEXER, 127);
// drive_straight(10, 300, 100, 200);
// set_motors(0);
drive_straight(10, 1150, 127, 200);
set_motors(0);
delay(1000);
}
