...
// Flywheel and Intake Start
  ...
  turn_right(635, 90, 750);

  printf("turn\r\n");
motor_tare_position(10);
drive_straight(10, 305, 127, 200);
set_motors(0);
delay(1000);
doub_shot();
motor_move(MOTOR_INTAKE, 127);

 turn_right(100, 127, 100);
 ...
 turn_right(600, 100, 500);

 drive_straight(10, -4220, -200, 200);
 set_motors(-5);
 delay(500);
}
