...
// Flywheel and Intake Start
  ...
  drive_straight(10, -1475, -127, 200);
  set_motors(0);
  delay(750);

  turn_right(628, 90, 750);

  printf("turn\r\n");
motor_tare_position(10);
drive_straight(10, 300, 127, 200);
set_motors(0);
delay(1000);
doub_shot();
motor_move(MOTOR_INTAKE, 127);

 turn_right(103, 127, 100);
 drive_straight(10, 1300, 100, 200);
 set_motors(0);
 delay(1000);


 turn_right(50, 127, 100);
 ...
 drive_straight(10, 525, 60, 200);
 set_motors(0);
 delay(500);

 drive_straight(10, -70, -60, 200);
 set_motors(0);
 delay(500);

turn_right(387, 100, 500);
