...
//Backward after Getting Ball, Does a Wall Reset
  drive_straight(10, -3200, -85, 200);
  set_motors(0);
  delay(500);

//Forward after Wall Reset
  drive_straight(10, 130, 100, 200);
  set_motors(0);
  delay(500);
...
//Center Park
  turn_right(680, 127, 1000);
  drive_straight(10, -3250, -100, 200);
  set_motors(0);
  delay(1000);
  turn_left(665, 127, 1000);
